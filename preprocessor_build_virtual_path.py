# This script reads a csv file containing source and target paths,
# then creates symbolic links to organize files in a specific folder structure under /data
